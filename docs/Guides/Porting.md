...
Before you get started with porting open source to z/OS, read the [Getting Started Guide](Pre-req) to set up your environment. We also recommend that you read the [contributing guide](https://github.com/zopencommunity/meta/blob/main/CONTRIBUTING).
...
Please follow the [contributing guidelines](https://github.com/zopencommunity/meta/blob/main/CONTRIBUTING).
