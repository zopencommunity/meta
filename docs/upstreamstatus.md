...
![Current Patch LOC Trend](./images/upstream/treeport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2024-01-03 | PR2/lang.m4.patch | 0 |
| 2024-01-03 | PR3/local.at.patch | 0 |
...
| 2022-05-18 | build-aux/config.guess.patch | 0 |
| 2022-05-18 | configure.patch | 0 |
| 2022-05-18 | lib/autoconf/general.m4.patch | 0 |
| 2022-05-18 | lib/autoconf/status.m4.patch | 0 |
| 2022-05-18 | tests/local.at.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/jqport_current_patch_loc_trend.png)
...
**Current Lines of Code:** 142  
**Current # of Patch files:** 4

### Trend of Current Patch LOC

![Current Patch LOC Trend](./images/upstream/libserdesport_current_patch_loc_trend.png)
...
| src/serdes-common.h.patch | 15 |
| src/serdes_int.h.patch | 17 |
| src/tinycthread.c.patch | 97 |
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2024-01-29 | mklove/Makefile.base.patch | 0 |
...
**Current Lines of Code:** 130  
**Current # of Patch files:** 5

### Trend of Current Patch LOC

![Current Patch LOC Trend](./images/upstream/tclport_current_patch_loc_trend.png)

### Current Patch Details

| File | LOC |
| --- | --- |
| PR1/namecollision.patch | 42 |
| PR1/neederrno.patch | 12 |
| PR1/remove_oe_sockets_hardcode.patch | 17 |
| PR2/tclUnixNotfy.c.patch | 15 |
| PR2/tclUnixThrd.c.patch | 44 |
...
![Current Patch LOC Trend](./images/upstream/libgcryptport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/pinentryport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libssh2port_current_patch_loc_trend.png)
...
**Current Lines of Code:** 120  
**Current # of Patch files:** 5

### Trend of Current Patch LOC

![Current Patch LOC Trend](./images/upstream/m4port_current_patch_loc_trend.png)

### Current Patch Details

| File | LOC |
| --- | --- |
| PR2/builtin.c.patch | 55 |
| PR2/canonicalize-lgpl.c.patch | 22 |
| PR2/configure.patch | 13 |
| PR4/doc/m4.texi.patch | 17 |
| PR4/src/format.c.patch | 13 |
...
![Current Patch LOC Trend](./images/upstream/thesilversearcherport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/grepport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/ncursesport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/hexcurseport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libbsdport_current_patch_loc_trend.png)
...
| src/fgetln.c.patch | 11 |
| src/flopen.c.patch | 15 |
| src/readpassphrase.c.patch | 24 |
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2024-01-30 | src/progname.c.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/victoriametricsport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2024-03-04 | lib_filestream.patch | 36 |
| 2024-03-04 | lib_fs.patch | 34 |
| 2024-03-04 | lib_memory.patch | 37 |
...
![Current Patch LOC Trend](./images/upstream/zlib-ngport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/pkgconfigport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/doxygenport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2025-02-02 | CMakeLists.txt.patch | 0 |
| 2025-02-02 | CMakeListsTest.txt.patch | 0 |
| 2025-02-02 | os-inl.h.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/depot_toolsport_current_patch_loc_trend.png)
...
| 2024-12-27 | zos_debug.patch | 0 |
| 2024-12-17 | pyth312.patch | 0 |
| 2024-12-17 | zos_debug.patch | 197 |
| 2024-07-26 | pyth312.patch | 60 |
| 2024-07-26 | pyth312.patch | -60 |
| 2024-07-25 | pyth312.patch | 47 |
| 2024-02-26 | requirements.patch | 0 |
| 2024-02-23 | cipd.patch | 0 |
| 2024-02-23 | detect_host_arch.py.patch | 0 |
| 2024-02-23 | download_from_google_storage.py.patch | 0 |
| 2024-02-23 | gclient.py.patch | 0 |
| 2024-02-23 | gclient_paths.py.patch | 0 |
| 2024-02-23 | gclient_utils.py.patch | 0 |
| 2024-02-23 | vpython3.patch | 0 |
| 2024-02-22 | setenv.patch | 0 |
...
**Current Lines of Code:** 86  
**Current # of Patch files:** 3

### Trend of Current Patch LOC

![Current Patch LOC Trend](./images/upstream/patchport_current_patch_loc_trend.png)

### Current Patch Details

| File | LOC |
| --- | --- |
| PR1/pathmax.h.patch | 14 |
| PR1/string.in.h.patch | 60 |
| PR1/util.c.patch | 12 |
...
**Current Lines of Code:** 81  
**Current # of Patch files:** 4

### Trend of Current Patch LOC

![Current Patch LOC Trend](./images/upstream/gawkport_current_patch_loc_trend.png)

### Current Patch Details

| File | LOC |
| --- | --- |
| PR1/ascii-io.patch | 39 |
| PR1/noprotoscope.patch | 16 |
| PR1/zosdoesnotmeanebcdic.patch | 13 |
| PR2/install-sh.patch | 13 |
...
![Current Patch LOC Trend](./images/upstream/getoptport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/expectport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libassuanport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/xmltoport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2023-02-13 | xmlto.in.patch | 0 |
| 2023-02-12 | configure.patch | 74 |
| 2023-02-10 | xmlto.in.patch | 25 |
...
![Current Patch LOC Trend](./images/upstream/cppcheckport_current_patch_loc_trend.png)
...
| 2024-05-14 | findDependencies.cmake.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/libtoolport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/nanoport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/logrotateport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/gnport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/texinfoport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libgpgerrorport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/expatport_current_patch_loc_trend.png)
...
| 2023-02-23 | PR2.patch | 0 |
| 2022-10-20 | PR2.patch | 14 |
| 2022-10-07 | PR1.patch | 24 |
| 2022-10-07 | PR1/configure.ac.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/terraformport_current_patch_loc_trend.png)
...
**Current Lines of Code:** 50  
**Current # of Patch files:** 3

### Trend of Current Patch LOC

![Current Patch LOC Trend](./images/upstream/libsasl2port_current_patch_loc_trend.png)
...
| saslauthd/auth_getpwent.c.patch | 21 |
...
![Current Patch LOC Trend](./images/upstream/automakeport_current_patch_loc_trend.png)

### Current Patch Details

| File | LOC |
| --- | --- |
| PR1/automake.in.patch | 13 |
| PR1/configure.patch | 22 |
| PR1/distdir.am.patch | 12 |
...
| 2022-11-27 | PR1/pr1.patch | 0 |
| 2022-11-23 | PR1/test-driver.patch | 0 |
| 2022-11-09 | PR1/pr1.patch | 51 |
| 2022-11-09 | PR1/test-driver.patch | 13 |
| 2022-11-09 | PR1/Makefile.in.patch | 0 |
| 2022-11-09 | PR1/distdir.am.patch | -12 |
| 2022-11-09 | PR2/test-driver.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/lessport_current_patch_loc_trend.png)
...
| 2024-05-07 | Makefile.in.patch | 0 |
| 2024-05-07 | PR1.patch | 0 |
| 2024-01-21 | Makefile.in.patch | 0 |
| 2024-01-21 | edit.c.patch | 0 |
| 2024-01-21 | lesstest/Makefile.patch | 0 |
| 2024-01-21 | ttyin.c.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/xxhashport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/tigport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/lazygitport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/poptport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/whichport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/sedport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/sqliteport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/luvport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libffiport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/lynxport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/netpbmport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/gmpport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libgpgmeport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2024-03-04 | ath.h.patch | 22 |
| 2024-03-04 | libtool.m4.patch | 15 |
| 2024-03-04 | ath.h.patch | 14 |
| 2024-03-04 | libtool.m4.patch | 15 |
...
![Current Patch LOC Trend](./images/upstream/npthport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libksbaport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/avro-c-libport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/ctagsport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/git-extrasport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/my_basicport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/sshpassport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/git-lfsport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/bzip2port_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/cunitport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/makeport_current_patch_loc_trend.png)
...
| 2023-01-20 | PR1.patch | 0 |
| 2022-11-21 | PR1.patch | 247 |
| 2022-11-21 | PR1/initial_port.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/curlport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2025-02-10 | temp.patch | 0 |
| 2025-01-30 | temp.patch | 30 |
| 2023-08-28 | system.h.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/xzport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/opensslport_current_patch_loc_trend.png)
...
| 2022-07-10 | 0012-011_version.patch | 0 |
| 2022-06-17 | 0021-020_zseries.patch | 5466 |
| 2022-06-17 | 020_zseries.patch | 0 |
| 2022-06-17 | 025_zOSA.patch | 0 |
| 2022-06-15 | 025_newzOSB.patch | 0 |
| 2022-06-15 | 025_zOSB.patch | 0 |
...
| 2022-06-09 | PR1/config.pm.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/libgdbmport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libpipelineport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libpcre2port_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libxsltport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libpcreport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/libmdport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/tarport_current_patch_loc_trend.png)

### Current Patch Details

| File | LOC |
| --- | --- |
| gnu/fdopendir.c.patch | 14 |
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2023-11-22 | gnu/openat-proc.c.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/nghttp2port_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/bisonport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/ncduport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/luaport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/lpegport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/stowport_current_patch_loc_trend.png)
...
**Current Lines of Code:** 12  
**Current # of Patch files:** 1

### Trend of Current Patch LOC

![Current Patch LOC Trend](./images/upstream/libxml2port_current_patch_loc_trend.png)

### Current Patch Details

| File | LOC |
| --- | --- |
| PR1/configure.patch | 12 |
...
![Current Patch LOC Trend](./images/upstream/zlibport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2023-04-12 | configure.patch | 0 |
| 2022-11-15 | PR1/movedashellinkoption.patch | 0 |
| 2022-11-15 | PR1/removeoldmap.patch | 0 |
| 2022-11-15 | configure.patch | 14 |
| 2022-07-22 | PR1/movedashellinkoption.patch | 33 |
| 2022-07-22 | PR1/removeoldmap.patch | 1934 |
| 2022-07-22 | zconf.h.cmakein.patch | 0 |
| 2022-07-22 | zconf.h.in.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/man-dbport_current_patch_loc_trend.png)
...
| 2023-05-29 | manconv.c.patch | 0 |
| 2023-05-29 | manconv_client.c.patch | 0 |
| 2023-05-29 | manconv_main.c.patch | 0 |
| 2023-05-29 | convert.c.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/wgetport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2023-11-18 | PR1/netrc.c.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/gnulibport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2022-11-27 | PR1/gnulib-tool.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/htopport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/duckdbport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2024-06-03 | linenoise.cpp.patch | 0 |
| 2024-06-03 | entropy_poll.cpp.patch | 0 |
| 2024-01-22 | entropy_poll.cpp.patch | 13 |
| 2024-01-22 | linenoise.cpp.patch | 14 |
| 2023-08-23 | extension_config.cmake.patch | 0 |
| 2023-08-21 | extension_config.cmake.patch | 24 |
| 2023-06-16 | 01-concurrentqueue.h.patch | 0 |
| 2023-06-16 | 01-file_system.cpp.patch | 0 |
| 2023-06-16 | 02-concurrentqueue.h.patch | 0 |
| 2023-06-16 | 02-file_system.cpp.patch | 0 |
| 2023-06-16 | fast_float.h.patch | 0 |
| 2023-06-16 | httplib.hpp.patch | 0 |
| 2023-06-16 | lightweightsemaphore.h.patch | 0 |
| 2023-06-16 | mutex.hpp.patch | 0 |
| 2023-05-31 | 01-concurrentqueue.h.patch | 25 |
| 2023-05-31 | 01-file_system.cpp.patch | 73 |
| 2023-05-31 | 02-concurrentqueue.h.patch | 25 |
| 2023-05-31 | 02-file_system.cpp.patch | 81 |
| 2023-05-31 | fast_float.h.patch | 25 |
| 2023-05-31 | httplib.hpp.patch | 43 |
| 2023-05-31 | lightweightsemaphore.h.patch | 106 |
| 2023-05-31 | mutex.hpp.patch | 27 |
...
![Current Patch LOC Trend](./images/upstream/powerlinegoport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2024-11-26 | segment-virtualenv.go.patch | 0 |
| 2023-06-27 | segment-virtualenv.go.patch | 29 |
| 2023-05-25 | exitcode_zos.patch | 0 |
| 2023-05-20 | 0001-Add-exit-codes-for-IBM-zOS.patch | 57 |
...
![Current Patch LOC Trend](./images/upstream/c3270port_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2024-06-25 | c3270/Makefile.obj.in.patch | 0 |
| 2024-06-25 | c3270/configure.in.patch | 0 |
| 2024-06-25 | c3270/configure.patch | 0 |
| 2024-06-25 | lib/3270/Makefile.obj.in.patch | 0 |
| 2024-06-25 | s3270/Makefile.obj.in.patch | 0 |
| 2024-06-25 | tcl3270/Makefile.obj.in.patch | 0 |
| 2024-06-25 | x3270/Makefile.obj.in.patch | 0 |
| 2024-06-25 | x3270if/configure.in.patch | 0 |
| 2024-06-25 | x3270if/configure.patch | 0 |
| 2024-06-22 | Common/mkfb.c.patch | 0 |
...
![Current Patch LOC Trend](./images/upstream/dos2unixport_current_patch_loc_trend.png)
...
![Current Patch LOC Trend](./images/upstream/caddyport_current_patch_loc_trend.png)
...
| Commit Date | File | Delta LOC |
| --- | --- | --- |
| 2024-04-03 | badger_1-6-2.patch | 0 |
| 2024-04-03 | badger_2-2007-4.patch | 0 |
| 2024-04-03 | caddy.patch | 0 |
