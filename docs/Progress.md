...
* [gitport](https://github.com/zopencommunity/gitport)
* [vimport](https://github.com/zopencommunity/vimport)
* [tclport](https://github.com/zopencommunity/tclport)
* [bashport](https://github.com/zopencommunity/bashport)
...
| [curlport](https://github.com/zopencommunity/curlport) | 72 | Skipped |curl, cmake, m4, coreutils, xz, perl, automake, make, ncurses, bison, libtool, help2man, gettext, openssl, git, man-db, tar, expat, tcl, bash, rsync, gawk, xxhash, zstd, lz4, bzip2, jq, sed, grep, diffutils, texinfo, wget, gperf, patch, libpipeline, php, groff, findutils, screen, ncdu, cscope, gnulib, hello, meta, which, neovim, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, terraform, pinentry, c3270, ntbtls, librdkafka, oniguruma, luarocks, avro-c-lib, libserdes, moreutils, gn, dos2unix, buildkite, gitlab-runner, doxygen, gin, frp, maven, libgpgme, cronie
| [gzipport](https://github.com/zopencommunity/gzipport) | 56 | 100.0% |autoconf, ninja, less, curl, m4, coreutils, xz, perl, automake, make, ncurses, bison, libtool, gettext, openssl, git, man-db, tar, tcl, bash, rsync, gawk, xxhash, zstd, lz4, bzip2, jq, sed, sshpass, texinfo, wget, gperf, patch, php, findutils, screen, ncdu, flex, cscope, hello, sqlite, meta, which, neovim, direnv, openssh, thesilversearcher, oniguruma, moreutils, gn, dos2unix, util-linux, prometheus, git-lfs, logrotate, lpeg
| [m4port](https://github.com/zopencommunity/m4port) | 55 | 98.3% |m4, coreutils, automake, make, bison, libtool, help2man, gettext, openssl, git, man-db, tar, expat, bash, rsync, sed, sshpass, texinfo, wget, php, re2c, groff, screen, ctags, flex, cscope, gnulib, hello, libiconv, which, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, pinentry, ntbtls, thesilversearcher, oniguruma, libmd, libbsd, jansson, gn, netpbm, util-linux, tmux, zlib-ng, doxygen, logrotate, libgpgme, libsasl2, cronie, bash-completion, hexcurse
| [autoconfport](https://github.com/zopencommunity/autoconfport) | 54 | 98.0% |autoconf, less, curl, m4, coreutils, automake, make, bison, libtool, help2man, gettext, git, man-db, tar, expat, bash, rsync, sed, sshpass, texinfo, wget, php, re2c, groff, screen, nano, ctags, gnulib, hello, libiconv, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, pinentry, ntbtls, thesilversearcher, oniguruma, libmd, libbsd, jansson, shdoc, util-linux, tmux, zlib-ng, doxygen, logrotate, libgpgme, libsasl2, cronie, bash-completion, hexcurse
| [gitport](https://github.com/zopencommunity/gitport) | 52 | Skipped |git, man-db, vim, tar, expat, rsync, sshpass, texinfo, wget, zoslib, patch, libgdbm, libpipeline, php, re2c, zip, ncdu, unzip, ctags, gnulib, hello, sqlite, meta, zigi, terraform, tig, thesilversearcher, librdkafka, libmd, libbsd, jansson, protobuf, shdoc, githubcli, gn, dos2unix, boost, prometheus, buildkite, gitlab-runner, caddy, gitlabcli, doxygen, gin, frp, libgpgme, murex, grafana, cronie, git-extras, zedc_ascii, zusage
| [perlport](https://github.com/zopencommunity/perlport) | 49 | 98.9% |automake, make, bison, libtool, help2man, gettext, openssl, git, man-db, tar, expat, bash, rsync, sed, diffutils, texinfo, wget, php, re2c, groff, screen, ctags, gnulib, hello, libiconv, meta, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, pinentry, ntbtls, thesilversearcher, libmd, jansson, netpbm, util-linux, tmux, zlib-ng, doxygen, logrotate, libgpgme, stow, libsasl2, cronie, bash-completion, hexcurse
| [automakeport](https://github.com/zopencommunity/automakeport) | 48 | 71.4% |automake, make, bison, libtool, help2man, gettext, git, man-db, tar, expat, rsync, sed, sshpass, texinfo, wget, php, re2c, groff, screen, nano, ctags, gnulib, hello, libiconv, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, pinentry, ntbtls, thesilversearcher, oniguruma, libmd, libbsd, jansson, shdoc, util-linux, tmux, zlib-ng, doxygen, logrotate, libgpgme, libsasl2, cronie, bash-completion, hexcurse
...
| [zlibport](https://github.com/zopencommunity/zlibport) | 25 | 100.0% |curl, cmake, perl, git, expat, rsync, wget, lynx, sudo, libgpgerror, libssh2, openssh, gpg, tig, thesilversearcher, librdkafka, avro-c-lib, libserdes, boost, netpbm, nghttp2, libevent, libgpgme, libsasl2, cronie
...
| [xzport](https://github.com/zopencommunity/xzport) | 17 | 77.8% |automake, make, bison, libtool, help2man, gettext, git, man-db, expat, diffutils, texinfo, findutils, hello, thesilversearcher, libbsd, util-linux, cronie
...
Last updated:  2025-02-28T10:03:36.791265
