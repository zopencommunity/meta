...
| [bashport](https://github.com/zopencommunity/bashport) | 48 | 79.2% | apr, autoconf, avro-c-lib, bash-completion, bison, cpio, cronie, diffutils, direnv, ed, expat, flex, fmt, gflags, git, git-extras, gn, gradle, groovy, jansson, jenkins, jq, libarchive, libbsd, libiconv, libmd, libpsl, librdkafka, libsasl2, libxml2, libyaml, maven, meta, netpbm, oniguruma, procps, prometheus, prompters, re2c, redis, shdoc, texinfo, tree, vim, which, xmlto, zos-code-page-tools, zospstree |
| [diffutilsport](https://github.com/zopencommunity/diffutilsport) | 43 | 87.6% | apr, bash, bison, boost, byacc, coreutils, cronie, ctags, flex, gawk, getopt, git, gnulib, gpg, grep, groff, gzip, jq, jsonc, libassuan, libdio, libgcrypt, libgpgerror, libgpgme, libiconv, libksba, libpcre, libpcre2, libxml2, libxslt, libyaml, man-db, netpbm, npth, ntbtls, php, pinentry, re2c, rsync, texinfo, vim, which, xmlto |
| [grepport](https://github.com/zopencommunity/grepport) | 39 | 92.2% | apr, bash, bash-completion, bc, byacc, cpio, ctags, doxygen, fmt, gnulib, gzip, jenkins, jsonc, less, libpcre, libpcre2, librdkafka, libserdes, libsolv, libxslt, libyaml, m4, man-db, meta, ntbtls, openldap, perl, procps, prometheus, readline, redis, shdoc, snappy-c, stow, util-linux, wharf, which, xmlto, zlib-ng |
...
| [gettextport](https://github.com/zopencommunity/gettextport) | 30 | 94.4% | bash, coreutils, cronie, ctags, expat, getopt, git, gpg, hello, libassuan, libgcrypt, libgpgerror, libgpgme, libiconv, libksba, libpsl, libsasl2, libyaml, m4, man-db, nano, neovim, netpbm, npth, ntbtls, pinentry, procps, util-linux, uucp, which |
...
Last updated:  2025-07-27 06:12:23 UTC
