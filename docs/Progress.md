...
| [bashport](https://github.com/zopencommunity/bashport) | 49 | 79.2% | apr, autoconf, avro-c-lib, bash-completion, bison, blis, cpio, cronie, diffutils, direnv, ed, expat, flex, fmt, gflags, git, git-extras, gn, gradle, groovy, jansson, jenkins, jq, libarchive, libbsd, libiconv, libmd, libpsl, librdkafka, libsasl2, libxml2, libyaml, maven, meta, netpbm, oniguruma, procps, prometheus, prompters, re2c, redis, shdoc, texinfo, tree, vim, which, xmlto, zos-code-page-tools, zospstree |
...
| [check_goport](https://github.com/zopencommunity/check_goport) | 31 | 100.0% | buildkite, bump, caddy, chezmoi, direnv, frp, fx, gin, git-lfs, git-sizer, githubcli, gitlab-runner, gitlabcli, godsect, grafana, gum, hugo, lazygit, mkcert, murex, nats, osv-scanner, parse-gotest, powerlinego, s5cmd, terraform, ttype, wharf, yq, zosnc, zospstree |
...
| [blisport](https://github.com/zopencommunity/blisport) | 0 | 0.0% | None |
