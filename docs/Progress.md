...
| [grepport](https://github.com/zopencommunity/grepport) | 42 | 92.2% | apr, bash, bash-completion, bc, blis, byacc, check, cpio, ctags, doxygen, fmt, gnulib, gzip, jenkins, jsonc, less, libpcre, libpcre2, librdkafka, libserdes, libsolv, libxslt, libyaml, m4, man-db, meta, ntbtls, openldap, perl, procps, prometheus, quilt, readline, redis, shdoc, snappy-c, stow, util-linux, wharf, which, xmlto, zlib-ng |
| [opensslport](https://github.com/zopencommunity/opensslport) | 38 | 96.6% | apr, c3270, cmake, cronie, curl, expat, file, git, gpg, grpc, jq, libarchive, libassuan, libbsd, libevent, libgcrypt, libgpgerror, libksba, librabbitmq, librdkafka, libsasl2, libserdes, libssh2, llamacpp, lynx, nghttp2, ninja, npth, ntbtls, openldap, openssh, pinentry, redis, rsync, sudo, tcl, tcltls, wget |
| [gettextport](https://github.com/zopencommunity/gettextport) | 36 | 84.9% | bash, check, coreutils, cronie, ctags, curl, expat, getopt, git, gpg, hello, less, libassuan, libgcrypt, libgpgerror, libgpgme, libiconv, libksba, libpsl, libsasl2, libyaml, m4, make, man-db, nano, neovim, netpbm, npth, ntbtls, perl, pinentry, procps, util-linux, uucp, vim, which |
| [zlibport](https://github.com/zopencommunity/zlibport) | 33 | 100.0% | autoconf, avro-c-lib, boost, cmake, cronie, curl, expat, file, fish, git, gpg, grpc, jq, libevent, libgpgerror, libgpgme, libiconv, librdkafka, libsasl2, libserdes, libsolv, libssh2, llamacpp, lynx, netpbm, nghttp2, openssh, perl, rsync, sudo, thesilversearcher, tig, wget |
...
| [cmakeport](https://github.com/zopencommunity/cmakeport) | 32 | 82.4% | asio, avro-c-lib, boost, ccache, check, cjson, cmake, cppcheck, doxygen, duckdb, fish, fmt, gflags, grpc, jansson, jsonc, libevent, librabbitmq, libsolv, libuv, llamacpp, luv, neovim, ninja, popt, protobuf, spdlog, unzip, zedc_ascii, zip, zoslib, zusage |
...
| [ncursesport](https://github.com/zopencommunity/ncursesport) | 25 | 100.0% | bash, c3270, cscope, dialog, doom-ascii, emacs, fish, gettext, git, gpg, hexcurse, less, libgpgme, llamacpp, lynx, man-db, multitail, nano, ncdu, procps, screen, thesilversearcher, tig, tmux, vim |
| [check_pythonport](https://github.com/zopencommunity/check_pythonport) | 21 | 100.0% | apr, blis, c3270, ctags, curl, depot_tools, doxygen, file, git, gn, libdio, libpsl, libxml2, lz4, pinentry, re2c, redis, rsync, spdlog, vim, zstd |
...
| [libiconvport](https://github.com/zopencommunity/libiconvport) | 7 | 100.0% | bison, gettext, libxml2, libxslt, man-db, php, tig |
