...
| [gzipport](https://github.com/zopencommunity/gzipport) | 61 | 100.0% | autoconf, automake, bash, bison, bzip2, ccache, coreutils, cscope, curl, direnv, dos2unix, file, findutils, flex, gawk, gettext, git, git-lfs, gn, gperf, hello, jq, less, libpsl, libtool, logrotate, lpeg, lz4, m4, make, man-db, meta, moreutils, ncdu, ncurses, neovim, ninja, oniguruma, openssh, openssl, patch, perl, php, procps, prometheus, readline, rsync, screen, sed, sshpass, tar, tcl, texinfo, thesilversearcher, util-linux, uucp, wget, which, xxhash, xz, zstd |
| [tarport](https://github.com/zopencommunity/tarport) | 57 | 95.2% | apr, automake, bash, bzip2, ccache, coreutils, cscope, curl, direnv, ed, file, findutils, flex, gawk, gettext, git, git-lfs, gpg, grep, hello, jansson, jq, less, libarchive, libassuan, libbsd, libgcrypt, libgpgerror, libgpgme, libksba, libmd, libsasl2, libyaml, lpeg, m4, make, man-db, meta, ncdu, ncurses, neovim, ninja, npth, ntbtls, oniguruma, openssh, openssl, pinentry, procps, prometheus, re2c, readline, screen, sshpass, thesilversearcher, util-linux, uucp |
...
| [bashport](https://github.com/zopencommunity/bashport) | 47 | 79.2% | apr, autoconf, avro-c-lib, bash-completion, bison, cpio, cronie, diffutils, direnv, ed, expat, flex, fmt, gflags, git, git-extras, gn, gradle, groovy, jansson, jenkins, jq, libarchive, libbsd, libiconv, libmd, libpsl, librdkafka, libsasl2, libxml2, libyaml, maven, meta, netpbm, oniguruma, procps, prometheus, prompters, re2c, redis, shdoc, texinfo, tree, vim, which, zos-code-page-tools, zospstree |
| [diffutilsport](https://github.com/zopencommunity/diffutilsport) | 42 | 87.6% | apr, bash, bison, boost, byacc, coreutils, cronie, ctags, flex, gawk, getopt, git, gnulib, gpg, grep, groff, gzip, jq, jsonc, libassuan, libdio, libgcrypt, libgpgerror, libgpgme, libiconv, libksba, libpcre, libpcre2, libxml2, libxslt, libyaml, man-db, netpbm, npth, ntbtls, php, pinentry, re2c, rsync, texinfo, vim, which |
| [grepport](https://github.com/zopencommunity/grepport) | 38 | 92.2% | apr, bash, bash-completion, bc, byacc, cpio, ctags, doxygen, fmt, gnulib, gzip, jenkins, jsonc, less, libpcre, libpcre2, librdkafka, libserdes, libsolv, libxslt, libyaml, m4, man-db, meta, ntbtls, openldap, perl, procps, prometheus, readline, redis, shdoc, snappy-c, stow, util-linux, wharf, which, zlib-ng |
...
| [cmakeport](https://github.com/zopencommunity/cmakeport) | 30 | 82.4% | avro-c-lib, boost, ccache, cjson, cmake, cppcheck, doxygen, duckdb, fish, fmt, gflags, grpc, jansson, jsonc, libevent, librabbitmq, libsolv, libuv, llamacpp, luv, neovim, ninja, popt, protobuf, spdlog, unzip, zedc_ascii, zip, zoslib, zusage |
...
| [gawkport](https://github.com/zopencommunity/gawkport) | 18 | 93.3% | automake, bash-completion, coreutils, curl, expat, git, gzip, jsonc, libsolv, lzip, ncurses, openssh, procps, rsync, shdoc, sudo, vim, which |
| [pkgconfigport](https://github.com/zopencommunity/pkgconfigport) | 18 | 100.0% | avro-c-lib, ctags, groff, grpc, librabbitmq, librdkafka, libserdes, man-db, ncurses, netpbm, nghttp2, procps, redis, tcl, tcltls, thesilversearcher, tmux, util-linux |
...
| [getoptport](https://github.com/zopencommunity/getoptport) | 17 | 52.2% | avro-c-lib, coreutils, diffutils, fish, flex, libgpgme, librdkafka, moreutils, neovim, ninja, procps, sed, shdoc, sudo, thesilversearcher, util-linux, which |
...
| [flexport](https://github.com/zopencommunity/flexport) | 9 | 100.0% | autoconf, bison, cscope, doxygen, groff, man-db, netpbm, tmux, util-linux |
...
| [zipport](https://github.com/zopencommunity/zipport) | 6 | 100.0% | gpg, gradle, libgpgme, luarocks, neovim, unzip |
...
| [libpslport](https://github.com/zopencommunity/libpslport) | 3 | 100.0% | curl, git, llamacpp |
...
| [tclport](https://github.com/zopencommunity/tclport) | 3 | Skipped | expect, redis, tcltls |
| [unzipport](https://github.com/zopencommunity/unzipport) | 3 | 100.0% | gradle, luarocks, neovim |
...
Last updated:  2025-07-29 06:12:41 UTC
