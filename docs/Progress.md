...
* [curlport](https://github.com/zopencommunity/curlport)
* [lessport](https://github.com/zopencommunity/lessport)
* [vimport](https://github.com/zopencommunity/vimport)
* [tclport](https://github.com/zopencommunity/tclport)
* [jqport](https://github.com/zopencommunity/jqport)
...
* [depot_toolsport](https://github.com/zopencommunity/depot_toolsport)
...
* [git-extrasport](https://github.com/zopencommunity/git-extrasport)
* [zusageport](https://github.com/zopencommunity/zusageport)

## Projects with the most dependencies

| Package | # of Dependent Projects | Test Success Rate | Dependent projects
|---|---|---|--|
| [makeport](https://github.com/zopencommunity/makeport) | 144 | Skipped |make, coreutils, gzip, curl, zlib, cmake, less, perl, automake, ninja, m4, ncurses, bison, libtool, help2man, gettext, openssl, git, zotsample, man-db, pkgconfig, vim, tar, expat, tcl, bash, rsync, gawk, xxhash, zstd, lz4, bzip2, jq, sed, grep, diffutils, sshpass, texinfo, wget, gperf, zoslib, patch, libgdbm, libpipeline, php, re2c, groff, findutils, zip, screen, ncdu, unzip, nano, ctags, flex, cscope, gnulib, hello, sqlite, lua, libiconv, meta, libxml2, libpcre2, xmlto, getopt, libxslt, lynx, sudo, which, fzf, expect, neovim, npth, libgpgerror, libgcrypt, libassuan, libksba, direnv, libssh2, openssh, gpg, duckdb, pinentry, byacc, tig, c3270, ntbtls, thesilversearcher, librdkafka, libpcre, oniguruma, libmd, libbsd, jansson, luarocks, protobuf, avro-c-lib, llamacpp, libserdes, libuv, shdoc, githubcli, moreutils, zos-code-page-tools, gn, tree, dos2unix, zospstree, zosnc, boost, netpbm, util-linux, prometheus, gmp, nghttp2, libevent, tmux, gitlabcli, zlib-ng, doxygen, git-lfs, frp, popt, logrotate, libgpgme, lpeg, luv, cppcheck, grafana, s5cmd, stow, libsasl2, cronie, dialog, cjson, libdio, git-extras, zedc_ascii, bash-completion, zusage, spdlog, hexcurse, librabbitmq
| [coreutilsport](https://github.com/zopencommunity/coreutilsport) | 87 | 100.0% |gzip, less, perl, automake, ncurses, bison, libtool, gettext, git, man-db, pkgconfig, vim, expat, bash, rsync, xxhash, zstd, lz4, jq, sed, grep, diffutils, texinfo, zoslib, patch, libgdbm, php, re2c, groff, findutils, flex, gnulib, hello, lua, libiconv, meta, libxml2, libpcre2, getopt, sudo, which, neovim, direnv, openssh, byacc, tig, c3270, ntbtls, thesilversearcher, librdkafka, libpcre, oniguruma, libmd, libbsd, jansson, luarocks, protobuf, avro-c-lib, libserdes, shdoc, githubcli, moreutils, zos-code-page-tools, tree, dos2unix, zospstree, zosnc, boost, netpbm, util-linux, libevent, tmux, gitlabcli, fq, zlib-ng, doxygen, git-lfs, logrotate, cppcheck, libsasl2, cronie, libdio, git-extras, zedc_ascii, bash-completion, zusage, spdlog
| [zoslibport](https://github.com/zopencommunity/zoslibport) | 79 | 100.0% |patch, libgdbm, libpipeline, php, re2c, groff, findutils, zip, screen, ncdu, unzip, nano, ctags, flex, cscope, gnulib, hello, sqlite, lua, meta, libxml2, libpcre2, xmlto, getopt, libxslt, lynx, sudo, expect, neovim, npth, libgpgerror, libgcrypt, libassuan, libksba, libssh2, openssh, gpg, duckdb, pinentry, byacc, tig, c3270, ntbtls, thesilversearcher, librdkafka, libpcre, oniguruma, libmd, libbsd, jansson, protobuf, avro-c-lib, llamacpp, libserdes, libuv, shdoc, moreutils, gn, boost, netpbm, util-linux, my_basic, libevent, tmux, doxygen, popt, logrotate, libgpgme, lpeg, luv, cppcheck, libsasl2, cronie, dialog, bash-completion, zusage, spdlog, hexcurse, librabbitmq
| [curlport](https://github.com/zopencommunity/curlport) | 71 | Skipped |curl, cmake, less, perl, automake, ninja, m4, ncurses, bison, libtool, help2man, gettext, openssl, git, man-db, tar, expat, tcl, bash, rsync, gawk, xxhash, zstd, lz4, bzip2, jq, sed, grep, diffutils, texinfo, wget, gperf, patch, libpipeline, php, groff, findutils, screen, ncdu, cscope, gnulib, hello, meta, which, neovim, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, terraform, pinentry, c3270, ntbtls, librdkafka, oniguruma, luarocks, avro-c-lib, libserdes, moreutils, gn, dos2unix, buildkite, gitlab-runner, doxygen, gin, frp, maven, libgpgme, cronie
| [autoconfport](https://github.com/zopencommunity/autoconfport) | 55 | 98.0% |autoconf, make, coreutils, gzip, curl, less, automake, m4, bison, libtool, help2man, gettext, git, man-db, tar, expat, bash, rsync, sed, sshpass, texinfo, wget, php, re2c, groff, screen, nano, ctags, gnulib, hello, libiconv, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, pinentry, ntbtls, thesilversearcher, oniguruma, libmd, libbsd, jansson, shdoc, util-linux, tmux, zlib-ng, doxygen, logrotate, libgpgme, libsasl2, cronie, bash-completion, hexcurse
| [gzipport](https://github.com/zopencommunity/gzipport) | 52 | 100.0% |curl, less, perl, automake, ninja, m4, ncurses, bison, libtool, gettext, openssl, git, man-db, tar, tcl, bash, rsync, gawk, xxhash, zstd, lz4, bzip2, jq, sed, sshpass, texinfo, wget, gperf, patch, php, findutils, screen, ncdu, flex, cscope, hello, sqlite, meta, which, neovim, direnv, openssh, thesilversearcher, oniguruma, moreutils, gn, dos2unix, util-linux, prometheus, git-lfs, logrotate, lpeg
| [m4port](https://github.com/zopencommunity/m4port) | 52 | 98.3% |m4, bison, libtool, help2man, gettext, openssl, git, man-db, tar, expat, bash, rsync, sed, sshpass, texinfo, wget, php, re2c, groff, screen, ctags, flex, cscope, gnulib, hello, libiconv, which, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, pinentry, ntbtls, thesilversearcher, oniguruma, libmd, libbsd, jansson, gn, netpbm, util-linux, tmux, zlib-ng, doxygen, logrotate, libgpgme, libsasl2, cronie, bash-completion, hexcurse
...
| [perlport](https://github.com/zopencommunity/perlport) | 49 | 98.9% |automake, m4, bison, libtool, help2man, gettext, openssl, git, man-db, tar, expat, bash, rsync, sed, diffutils, texinfo, wget, php, re2c, groff, screen, ctags, gnulib, hello, libiconv, meta, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, pinentry, ntbtls, thesilversearcher, libmd, jansson, netpbm, util-linux, tmux, zlib-ng, doxygen, logrotate, libgpgme, stow, libsasl2, cronie, bash-completion, hexcurse
| [automakeport](https://github.com/zopencommunity/automakeport) | 48 | 71.4% |automake, m4, bison, libtool, help2man, gettext, git, man-db, tar, expat, rsync, sed, sshpass, texinfo, wget, php, re2c, groff, screen, nano, ctags, gnulib, hello, libiconv, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, pinentry, ntbtls, thesilversearcher, oniguruma, libmd, libbsd, jansson, shdoc, util-linux, tmux, zlib-ng, doxygen, logrotate, libgpgme, libsasl2, cronie, bash-completion, hexcurse
...
| [sedport](https://github.com/zopencommunity/sedport) | 31 | 84.7% |php, re2c, groff, libiconv, libxml2, libxslt, which, neovim, npth, libgpgerror, libgcrypt, libassuan, libksba, libssh2, openssh, gpg, pinentry, byacc, ntbtls, librdkafka, libmd, libbsd, jansson, shdoc, boost, util-linux, prompters, doxygen, libgpgme, libsasl2, bash-completion
| [diffutilsport](https://github.com/zopencommunity/diffutilsport) | 29 | 86.6% |texinfo, php, re2c, groff, ctags, flex, gnulib, libiconv, libxml2, libpcre2, xmlto, getopt, libxslt, which, npth, libgpgerror, libgcrypt, libassuan, libksba, gpg, pinentry, byacc, ntbtls, libpcre, boost, netpbm, libgpgme, cronie, libdio
| [opensslport](https://github.com/zopencommunity/opensslport) | 25 | 95.7% |git, expat, rsync, wget, lynx, sudo, npth, libgpgerror, libgcrypt, libassuan, libksba, libssh2, openssh, gpg, pinentry, c3270, ntbtls, librdkafka, libbsd, libserdes, nghttp2, libevent, libsasl2, cronie, librabbitmq
| [zlibport](https://github.com/zopencommunity/zlibport) | 24 | 100.0% |cmake, perl, git, expat, rsync, wget, lynx, sudo, libgpgerror, libssh2, openssh, gpg, tig, thesilversearcher, librdkafka, avro-c-lib, libserdes, boost, netpbm, nghttp2, libevent, libgpgme, libsasl2, cronie
...
| [cmakeport](https://github.com/zopencommunity/cmakeport) | 23 | 82.3% |cmake, ninja, zoslib, zip, unzip, neovim, duckdb, jansson, protobuf, avro-c-lib, llamacpp, libuv, boost, libevent, doxygen, popt, luv, cppcheck, cjson, zedc_ascii, zusage, spdlog, librabbitmq
| [xzport](https://github.com/zopencommunity/xzport) | 20 | 77.8% |autoconf, make, gzip, automake, m4, bison, libtool, help2man, gettext, git, man-db, expat, diffutils, texinfo, findutils, hello, thesilversearcher, libbsd, util-linux, cronie
| [ncursesport](https://github.com/zopencommunity/ncursesport) | 20 | 100.0% |gettext, git, man-db, vim, bash, screen, ncdu, nano, cscope, lynx, emacs, gpg, tig, c3270, thesilversearcher, llamacpp, tmux, libgpgme, dialog, hexcurse
...
| [pkgconfigport](https://github.com/zopencommunity/pkgconfigport) | 11 | 100.0% |groff, ctags, thesilversearcher, librdkafka, avro-c-lib, libserdes, netpbm, util-linux, nghttp2, tmux, librabbitmq
...
| [getoptport](https://github.com/zopencommunity/getoptport) | 10 | 52.2% |sudo, which, neovim, thesilversearcher, librdkafka, avro-c-lib, shdoc, moreutils, util-linux, libgpgme
...
| [findutilsport](https://github.com/zopencommunity/findutilsport) | 7 | 85.2% |gnulib, libiconv, libxml2, boost, netpbm, prometheus, bash-completion
...
| [zipport](https://github.com/zopencommunity/zipport) | 6 | 100.0% |unzip, fzf, neovim, gpg, luarocks, libgpgme
| [gawkport](https://github.com/zopencommunity/gawkport) | 5 | 93.1% |sudo, which, openssh, shdoc, bash-completion
| [flexport](https://github.com/zopencommunity/flexport) | 5 | 100.0% |cscope, xmlto, netpbm, tmux, doxygen
| [lessport](https://github.com/zopencommunity/lessport) | 4 | Skipped |git, man-db, jq, c3270
| [whichport](https://github.com/zopencommunity/whichport) | 4 | 100.0% |libserdes, boost, prometheus, libgpgme
| [groffport](https://github.com/zopencommunity/groffport) | 3 | 97.0% |libiconv, meta, openssh
| [unzipport](https://github.com/zopencommunity/unzipport) | 3 | 100.0% |fzf, neovim, luarocks
| [gnulibport](https://github.com/zopencommunity/gnulibport) | 3 | 100.0% |libbsd, doxygen, libgpgme
| [luaport](https://github.com/zopencommunity/luaport) | 3 | 100.0% |luarocks, lpeg, luv
...
| [zstdport](https://github.com/zopencommunity/zstdport) | 2 | 100.0% |librdkafka, libserdes
| [lz4port](https://github.com/zopencommunity/lz4port) | 2 | 100.0% |librdkafka, libserdes
| [gperfport](https://github.com/zopencommunity/gperfport) | 2 | 100.0% |hello, libiconv
| [libxml2port](https://github.com/zopencommunity/libxml2port) | 2 | 100.0% |libxslt, doxygen
...
| [poptport](https://github.com/zopencommunity/poptport) | 2 | 100.0% |logrotate, librabbitmq
| [check_pythonport](https://github.com/zopencommunity/check_pythonport) | 2 | 100.0% |libdio, spdlog
| [expatport](https://github.com/zopencommunity/expatport) | 1 | 100.0% |cronie
| [rsyncport](https://github.com/zopencommunity/rsyncport) | 1 | 94.3% |sed
| [jqport](https://github.com/zopencommunity/jqport) | 1 | Skipped |boost
| [wgetport](https://github.com/zopencommunity/wgetport) | 1 | 20.3% |hello
| [patchport](https://github.com/zopencommunity/patchport) | 1 | 94.1% |neovim
...
| [pythonport](https://github.com/zopencommunity/pythonport) | 1 | 100.0% |prometheus
| [comp_goport](https://github.com/zopencommunity/comp_goport) | 1 | 100.0% |prometheus
| [comp_clangport](https://github.com/zopencommunity/comp_clangport) | 1 | 100.0% |prometheus
| [opensshport](https://github.com/zopencommunity/opensshport) | 1 | 100.0% |gpg
...
| [libbsdport](https://github.com/zopencommunity/libbsdport) | 1 | 100.0% |libserdes
...
| [libuvport](https://github.com/zopencommunity/libuvport) | 1 | 98.8% |luv
...
| [check_goport](https://github.com/zopencommunity/check_goport) | 1 | 100.0% |hugo
...
| [re2cport](https://github.com/zopencommunity/re2cport) | 0 | 83.3% |
...
| [fzfport](https://github.com/zopencommunity/fzfport) | 0 | 100.0% |
...
| [libserdesport](https://github.com/zopencommunity/libserdesport) | 0 | 100.0% |
| [natsport](https://github.com/zopencommunity/natsport) | 0 | Skipped |
| [shdocport](https://github.com/zopencommunity/shdocport) | 0 | 100.0% |
| [depot_toolsport](https://github.com/zopencommunity/depot_toolsport) | 0 | Skipped |
...
| [netpbmport](https://github.com/zopencommunity/netpbmport) | 0 | 31.2% |
...
| [javaport](https://github.com/zopencommunity/javaport) | 0 | 100.0% |
...
| [doxygenport](https://github.com/zopencommunity/doxygenport) | 0 | 98.1% |
...
| [git-lfsport](https://github.com/zopencommunity/git-lfsport) | 0 | 94.1% |
...
| [check_clangport](https://github.com/zopencommunity/check_clangport) | 0 | 100.0% |
| [check_xlclangport](https://github.com/zopencommunity/check_xlclangport) | 0 | 100.0% |
| [check_javaport](https://github.com/zopencommunity/check_javaport) | 0 | 100.0% |
...
| [conanport](https://github.com/zopencommunity/conanport) | 0 | 54.0% |
| [git-extrasport](https://github.com/zopencommunity/git-extrasport) | 0 | Skipped |
| [zedc_asciiport](https://github.com/zopencommunity/zedc_asciiport) | 0 | 100.0% |
| [bash-completionport](https://github.com/zopencommunity/bash-completionport) | 0 | 100.0% |
| [zusageport](https://github.com/zopencommunity/zusageport) | 0 | Skipped |
| [spdlogport](https://github.com/zopencommunity/spdlogport) | 0 | 100.0% |
| [hexcurseport](https://github.com/zopencommunity/hexcurseport) | 0 | 100.0% |
| [librabbitmqport](https://github.com/zopencommunity/librabbitmqport) | 0 | 100.0% |

Last updated:  2025-03-19T04:53:39.836854
