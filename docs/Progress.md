...
| [m4port](https://github.com/ZOSOpenTools/m4port) | 37 | 98% |autoconf, automake, bison, coreutils, ctags, curl, expat, flex, gettext, git, gnulib, groff, gzip, hello, help2man, htop, libgcrypt, libgpgerror, libiconv, libksba, libtool, m4, make, man-db, npth, openssl, php, re2c, rsync, screen, sed, sshpass, tar, texinfo, top, wget, which
| [autoconfport](https://github.com/ZOSOpenTools/autoconfport) | 34 | 97% |autoconf, automake, bison, coreutils, ctags, curl, expat, gettext, git, gnulib, gzip, hello, help2man, htop, libgcrypt, libgpgerror, libiconv, libksba, libtool, m4, make, man-db, nano, npth, openssl, php, re2c, rsync, screen, sed, sshpass, tar, texinfo, wget
| [automakeport](https://github.com/ZOSOpenTools/automakeport) | 34 | 71% |autoconf, automake, bison, coreutils, ctags, curl, expat, gettext, git, gnulib, gzip, hello, help2man, htop, libgcrypt, libgpgerror, libiconv, libksba, libtool, m4, make, man-db, nano, npth, openssl, php, re2c, rsync, screen, sed, sshpass, tar, texinfo, wget
...
| [tarport](https://github.com/ZOSOpenTools/tarport) | 31 | 92% |automake, bash, bzip2, coreutils, cscope, ctags, curl, findutils, flex, gettext, git, grep, hello, htop, jq, less, libgcrypt, libgpgerror, libksba, m4, make, ncdu, ncurses, npth, openssh, openssl, re2c, screen, sqlite, sshpass, zotsample
...
| [sedport](https://github.com/ZOSOpenTools/sedport) | 22 | 84% |bash, coreutils, git, groff, libgcrypt, libgpgerror, libiconv, libksba, libssh2, libxml2, libxslt, m4, man-db, ncurses, npth, openssh, perl, php, pkg-config, re2c, vim, which
...
Last updated:  2023-05-19 15:16:53
