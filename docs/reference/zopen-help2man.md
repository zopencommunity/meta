...
&minus; generate man pages from help and version information for zopen and zopen&minus;* tools.</p>

<p style="margin-left:11%; margin-top: 1em">DIRECTORY &mdash; the existing directory to write the man pages.</p>
...
<tr>
<td style="border: 1px solid #ccc;"><code>zopen&minus;help2man /tmp/man1</code></td>
