...
<div class="header-with-back">
  ...
  <div class="nav-buttons">
    <a href="./zopen-importenvs" class="nav-link">← Prev</a>
  </div>
</div>

<h1 align="center">ZOPEN-VERSIONS</h1>

<h2>NAME</h2>

<p style="margin-left:11%; margin-top: 1em">zopen-versions
&minus; manual page for zopen-versions 0.8.4</p>

<h2>DESCRIPTION</h2>

<p style="margin-left:11%; margin-top: 1em">zopen&minus;versions
&minus; print installed version of z/OS tool and corresponding BREW latest version.</p>
