...
zopen-compute-builddeps &minus; manual page for zopen-compute-builddeps
0.8.4
</p>
...
<p style="margin-left: 11%; margin-top: 1em">
zopen-compute-builddeps [OPTION] [tool]
</p>
...
<p style="margin-left: 11%; margin-top: 1em">
zopen&minus;compute&minus;builddeps &minus; print out build dependencies
(transitive closure) for a given tool.
</p>
...
<p style="margin-left: 22%; margin-top: 1em">
zopen&minus;compute&minus;builddeps git
</p>
