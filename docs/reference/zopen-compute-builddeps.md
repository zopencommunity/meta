...
&minus; print out build dependencies (transitive closure) for a given tool.</p>

<p style="margin-left:11%; margin-top: 1em">NOTE: This tool will clone several repositories into a temporary directory for this computation.</p>
...
<tr>
<td style="border: 1px solid #ccc;"><code>zopen&minus;compute&minus;builddeps git</code></td>
