...
&minus; split a patch file into one patch file for each patch.
Patches are written to <code>split&minus;patches</code> in the current directory.</p>
...
<tr>
<td style="border: 1px solid #ccc;"><code>zopen&minus;split&minus;patch P1.patch</code></td>
