...
zopen-split-patch &minus; manual page for zopen-split-patch 0.8.4
</p>
...
<p style="margin-left: 11%; margin-top: 1em">
zopen-split-patch [OPTION] [PATCHFILE]
</p>
...
<p style="margin-left: 11%; margin-top: 1em">
zopen&minus;split&minus;patch &minus; split a patch file into one patch
file for each patch.
</p>

<p style="margin-left: 22%; margin-top: 1em">
Patches are written to split&minus;patches in the current directory.
</p>
...
<td width="41%">
<p style="margin-top: 1em">display this help and exit.</p>
</td>
...
Example:
<br />
zopen&minus;split&minus;patch P1.patch
</p>

<p style="margin-left: 22%">
write P1.patch into multiple patches under split&minus;patches
</p>
