...
zopen-compare-versions &minus; manual page for zopen-compare-versions
0.8.4
</p>
...
<p style="margin-left: 11%; margin-top: 1em">
zopen&minus;compare&minus;versions &minus; print installed version of z/OS
tool and corresponding BREW latest version
zopen&minus;compare&minus;versions [OPTION] Options:
</p>
