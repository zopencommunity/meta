...
parser = OptionParser(description="Add a team to one or more repositories with a given permission level in the zopencommunity organization on GitHub Enterprise.", usage="%prog [options]")
